...
<a href="#" className="text-[16px] text-Cyan flex gap-2 border-b border-Cyan pb-1 w-[170px] font-heading mt-3">See how Flyo works <img src={arrow} alt="arrow" className="w-[10%]"/></a>
